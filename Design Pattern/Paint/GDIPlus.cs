...
namespace Paint
{
    ...
    internal class GDIPlus
    {
        ...
        {
            return "GDIPlus PrintLine: x1=" + x1.ToString() + " y1=" + y1.ToString() + " x2=" + x2.ToString() + " y2=" + y2.ToString();
        }
        ...
        {
            return "GDIPlus PrintRround: x1=" + x.ToString() + " y=" + y.ToString() + " radius=" + radius.ToString();
        }
